...
Elm.Helpers.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Helpers = Elm.Native.Helpers.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var randomFloat = $Native$Helpers.randomFloat;
   var print = $Native$Helpers.print;
   var get = $Native$Helpers.get;
   var set = $Native$Helpers.set;
   var NoLocalStorage = {ctor: "NoLocalStorage"};
   return _elm.Helpers.values = {_op: _op,set: set,get: get,print: print,randomFloat: randomFloat,NoLocalStorage: NoLocalStorage};
};
Elm.SpeedMatch = Elm.SpeedMatch || {};
Elm.SpeedMatch.make = function (_elm) {
   "use strict";
   _elm.SpeedMatch = _elm.SpeedMatch || {};
   if (_elm.SpeedMatch.values) return _elm.SpeedMatch.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Char = Elm.Char.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var KeyPresses = F2(function (a,b) {    return {beingPressed: a,wentDown: b};});
   var foldPresses = F2(function (presses,acc) {
      var _p0 = acc;
      var beingPressed = _p0.beingPressed;
      var wentDown = _p0.wentDown;
      var newWentDown = A2($Set.diff,presses,beingPressed);
      return _U.update(acc,{wentDown: newWentDown,beingPressed: presses});
   });
   var loadCss = "\n    var head   = document.getElementsByTagName(\'head\')[0];\n    var link   = document.createElement(\'link\');\n    link.rel   = \'stylesheet\';\n    link.type  = \'text/css\';\n    link.href  = \'http://localhost:8000/style.css\';\n    link.media = \'all\';\n    head.appendChild(link);";
   var renderWelcome = function (model) {
      var personalBest = function () {
         var _p1 = model.personalBest;
         if (_p1.ctor === "Just") {
               return A2($Basics._op["++"],"Your best score so far is ",A2($Basics._op["++"],$Basics.toString(_p1._0),", try to beat that"));
            } else {
               return "";
            }
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("card card-fadeout welcome")]),
      _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("To start game click or press left/right arrow")]))
              ,A2($Html.p,_U.list([]),_U.list([$Html.text(personalBest)]))
              ,A2($Html.p,_U.list([]),_U.list([$Html.text("Good luck!")]))]));
   };
   var Render2 = {ctor: "Render2"};
   var Render1 = {ctor: "Render1"};
   var Dont = {ctor: "Dont"};
   var renderPersonalBest = function (model) {
      var score = function () {    var _p2 = model.personalBest;if (_p2.ctor === "Just") {    return $Basics.toString(_p2._0);} else {    return "0";}}();
      return $Html.text(A2($Basics._op["++"],"Personal best: ",score));
   };
   var renderSummary = function (model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("summary-container")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("summary card")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("score")]),
              _U.list([$Html.text(A2($Basics._op["++"],"Your score: ",$Basics.toString(model.pointsOverall)))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("nShape")]),
              _U.list([$Html.text(A2($Basics._op["++"],"Total shapes: ",$Basics.toString(model.nShape)))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("averageResponse")]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Average response: ",
              $Basics.toString($Basics.round(model.totalTime / $Basics.toFloat(model.nShape)))))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("personalBest")]),_U.list([renderPersonalBest(model)]))]))]));
   };
   var appendClass = F2(function (c1,c2) {    return A2($Basics._op["++"],c1,A2($Basics._op["++"]," ",c2));});
   var mkClassAttr = function (f) {    return _U.list([$Svg$Attributes.$class(f(""))]);};
   var augmentRender = F3(function (fn,attrs,shapes) {
      var rfn = F2(function (a,s) {    return A2(fn,A2($List.append,attrs,a),A2($List.append,shapes,s));});
      return rfn;
   });
   var renderSquare = F2(function (attrs,s) {
      return A5(augmentRender,
      $Svg.rect,
      _U.list([$Svg$Attributes.fill("#AE19FF")
              ,$Svg$Attributes.x("0")
              ,$Svg$Attributes.y("0")
   ...
   var renderCircle = F2(function (attrs,s) {
      return A5(augmentRender,
      $Svg.circle,
      _U.list([$Svg$Attributes.fill("#3C45FF"),$Svg$Attributes.r("50"),$Svg$Attributes.cx("50"),$Svg$Attributes.cy("50")]),
      _U.list([]),
      attrs,
      s);
   });
   var renderTriangle = F2(function (attrs,s) {
      return A5(augmentRender,$Svg.polygon,_U.list([$Svg$Attributes.fill("#FFDB3C"),$Svg$Attributes.points("0,100 50,0 100,100")]),_U.list([]),attrs,s);
   });
   var renderIncorrect = function (model) {
      var $class = _U.eq(A2($Basics._op["%"],model.nShape,2),1) ? "fadeinout2" : "fadeinout1";
      return A2($Svg.polygon,
      _U.list([$Svg$Attributes.$class($class)
              ,$Svg$Attributes.points("25,30 45,50 25,70 30,75 50,55 70,75 75,70 55,50 75,30 70,25 50,45 30,25")
              ,$Svg$Attributes.fill("red")]),
      _U.list([]));
   };
   var renderCheckmark = function (model) {
      var $class = _U.eq(A2($Basics._op["%"],model.nShape,2),1) ? "fadeinout2" : "fadeinout1";
      return A2($Svg.polygon,
      _U.list([$Svg$Attributes.$class($class),$Svg$Attributes.points("10,50 50,80 90,20 80,15 50,70"),$Svg$Attributes.fill("green")]),
      _U.list([]));
   };
   var renderDoubleShape = F3(function (fn,attrs,model) {
      var second = _U.list([]);
      var first = _U.list([]);
      var correct = model.lastCorrect;
      var check = function () {
         var _p3 = correct;
         if (_p3.ctor === "Just") {
               return _U.eq(model.nShape,1) ? _U.list([]) : A2($List._op["::"],_p3._0 ? renderCheckmark(model) : renderIncorrect(model),_U.list([]));
            } else {
               return _U.list([]);
            }
      }();
      var hide = appendClass("hide");
      var fadeout = appendClass("fadeout");
      var fadein = appendClass("fadein");
      var shape = appendClass("shape");
      var cfadein = mkClassAttr(function (_p4) {    return fadein(shape(_p4));});
      var cfadeout = mkClassAttr(function (_p5) {    return (_U.eq(model.nShape,0) ? hide : $Basics.identity)(fadeout(shape(_p5)));});
      var rfn = function (rt) {
         var _p6 = rt;
         switch (_p6.ctor)
         {case "Render1": return A5(augmentRender,$Svg.g,_U.list([]),_U.list([A2(fn,cfadein,first),A2(fn,cfadeout,second)]),_U.list([]),check);
            case "Render2": return A5(augmentRender,$Svg.g,_U.list([]),_U.list([A2(fn,cfadeout,first),A2(fn,cfadein,second)]),_U.list([]),check);
            default: return A2($Svg.g,_U.list([]),_U.list([A2(fn,cfadeout,first),A2(fn,cfadeout,second)]));}
      };
      return rfn;
   });
   var renderShapes = function (model) {
      var square = A3(renderDoubleShape,renderSquare,_U.list([]),model);
      var circle = A3(renderDoubleShape,renderCircle,_U.list([]),model);
      var triangle = A3(renderDoubleShape,renderTriangle,_U.list([]),model);
      var rt = _U.eq(A2($Basics._op["%"],model.nShape,2),0) ? Render2 : Render1;
      var shape = model.shape;
      var _p7 = shape;
      switch (_p7.ctor)
      {case "Triangle": return _U.list([triangle(rt),circle(Dont),square(Dont)]);
         case "Square": return _U.list([triangle(Dont),circle(Dont),square(rt)]);
         default: return _U.list([triangle(Dont),circle(rt),square(Dont)]);}
   };
   var renderGame = function (model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("game-container")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("clock")]),
              _U.list([$Html.text($Basics.toString($Basics.ceiling($Time.inSeconds(model.timeLeft))))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("game")]),
              _U.list([A2($Svg.svg,
              _U.list([$Svg$Attributes.width("200"),$Svg$Attributes.height("200")]),
              _U.list([A2($Svg.g,_U.list([$Svg$Attributes.transform("translate(50,50)")]),renderShapes(model))]))]))]));
   };
   var adjustSpree = F2(function (guessCorrect,model) {
      return guessCorrect ? _U.update(model,{correctSpree: model.correctSpree + 1}) : _U.update(model,{correctSpree: 0});
   });
   var awardPoints = F2(function (guessCorrect,model) {
      return guessCorrect ? _U.update(model,{pointsOverall: model.pointsOverall + model.pointsPerGuess}) : model;
   });
   var $break = F2(function (arrow,model) {    var a = A2($Debug.watch,"arrow",arrow);return model;});
   var storeCorrect = F2(function (correct,model) {    return _U.update(model,{lastCorrect: $Maybe.Just(correct)});});
   var adjustPointsAward = F2(function (guessCorrect,model) {
      return guessCorrect ? _U.update(model,{pointsPerGuess: A2($Basics.min,150,model.correctSpree * 2 + model.pointsPerGuess)}) : _U.update(model,
      {pointsPerGuess: 10});
   });
   var emptyPB = function (model) {    return _U.update(model,{personalBest: $Maybe.Just(0)});};
   var barrier = function () {
      var f = F2(function (input,_p8) {
         var _p9 = _p8;
         var _p16 = _p9._1;
         return $List.isEmpty(_p16) ? {ctor: "_Tuple2",_0: true,_1: _U.list([])} : A3($List.foldl,
         F2(function (_p11,_p10) {
            var _p12 = _p11;
            var _p15 = _p12._0;
            var _p13 = _p10;
            var _p14 = _p13._1;
            var newrp = $Basics.not(_p15) ? A2($List._op["::"],_p12._1,_p14) : _p14;
            return {ctor: "_Tuple2",_0: _p15 || _p13._0,_1: newrp};
         }),
         {ctor: "_Tuple2",_0: false,_1: _U.list([])},
         A2($List.map,function (p) {    return {ctor: "_Tuple2",_0: p(input),_1: p};},_p16));
      });
      return f;
   }();
   var every = A2($List.foldl,F2(function (x,y) {    return x && y;}),true);
   var maybeToBool = function (m) {    var _p17 = m;if (_p17.ctor === "Just") {    return true;} else {    return false;}};
   var NoKey = {ctor: "NoKey"};
   var Up = {ctor: "Up"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var checkGuessCorrection = F2(function (arrow,model) {
      var _p18 = model.prevShape;
      if (_p18.ctor === "Nothing") {
            return true;
         } else {
            var shapeEquals = _U.eq(model.shape,_p18._0);
            return _U.eq(arrow,Left) && $Basics.not(shapeEquals) ? true : _U.eq(arrow,Right) && shapeEquals ? true : false;
         }
   });
   var score = F2(function (arrow,model) {
      var guessCorrect = A2(checkGuessCorrection,arrow,model);
      return A2(storeCorrect,guessCorrect,A2(adjustSpree,guessCorrect,A2(adjustPointsAward,guessCorrect,A2(awardPoints,guessCorrect,model))));
   });
   var keyPressed = function (_p19) {
      var _p20 = _p19;
      var _p21 = _p20.wentDown;
      return A2($Set.member,37,_p21) ? $Maybe.Just(Left) : A2($Set.member,39,_p21) ? $Maybe.Just(Right) : A2($Set.member,
      38,
      _p21) ? $Maybe.Just(Up) : $Maybe.Nothing;
   };
   var arrows = A3($Signal.filterMap,keyPressed,NoKey,A3($Signal.foldp,foldPresses,{beingPressed: $Set.empty,wentDown: $Set.empty},$Keyboard.keysDown));
   var NoAction = {ctor: "NoAction"};
   var SaveScore = {ctor: "SaveScore"};
   var Load = function (a) {    return {ctor: "Load",_0: a};};
   var Action = function (a) {    return {ctor: "Action",_0: a};};
   var TimeDelta = function (a) {    return {ctor: "TimeDelta",_0: a};};
   var CurrentTime = function (a) {    return {ctor: "CurrentTime",_0: a};};
   var KeyPress = function (a) {    return {ctor: "KeyPress",_0: a};};
   var input = $Signal.mergeMany(_U.list([A2($Signal.map,KeyPress,arrows),A2($Signal.map,TimeDelta,$Time.fps(60))]));
   var noInputUntilEvent = function (filters) {    return A2($Signal.map,$Basics.fst,A3($Signal.foldp,barrier,{ctor: "_Tuple2",_0: false,_1: filters},input));};
   var renderArrows = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("arrows-container")]),
      _U.list([A2($Html.div,
              _U.list([A2($Html$Events.onClick,address,KeyPress(Left)),$Html$Attributes.$class("left-arrow")]),
              _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("No match")]))]))
              ,A2($Html.div,
              _U.list([A2($Html$Events.onClick,address,KeyPress(Right)),$Html$Attributes.$class("right-arrow")]),
              _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("Match")]))]))]));
   });
   var view = F2(function (address,model) {
      var body = function () {
         var _p22 = model.stage;
         switch (_p22.ctor)
         {case "Welcome": return _U.list([renderWelcome(model),A2(renderArrows,address,model)]);
            case "Playing": return _U.list([renderGame(model),A2(renderArrows,address,model)]);
            case "GameOver": return _U.list([renderSummary(model),A2(renderArrows,address,model)]);
            default: return _U.list([renderSummary(model)
                                    ,A2(renderArrows,address,model)
                                    ,A2($Html.p,_U.list([]),_U.list([$Html.text("Press again to start another game")]))]);}
      }();
      var container = A2($Html.div,_U.list([$Svg$Attributes.$class("container")]),body);
      var m = model;
      return A2($Html.div,_U.list([]),_U.list([container]));
   });
   var isInitAction = function (action) {
      var _p23 = action;
      switch (_p23.ctor)
   ...
   var getRandomNumber = A2($Task.map,function (f) {    return CurrentTime($Maybe.Just(f));},$Helpers.randomFloat({ctor: "_Tuple0"}));
   var getPersonalBest = A2($Task.map,Load,$Task.toResult($Helpers.get("SpeedMatchPersonalBest")));
   var setPersonalBest = function (_p24) {    return $Task.toResult(A2($Helpers.set,"SpeedMatchPersonalBest",$Basics.toString(_p24)));};
   var totalTime = 50 * $Time.second;
   ...
   var init = {ctor: "_Tuple2"
              ,_0: {seed: $Random.initialSeed(20)
                   ...
                   ,timeLeft: totalTime
                   ,stage: Welcome
                   ,lastCorrect: $Maybe.Nothing
                   ,personalBest: $Maybe.Nothing}
              ,_1: $Effects.batch(_U.list([$Effects.task(getPersonalBest),$Effects.task(getRandomNumber)]))};
   var toCard = function (i) {    var _p25 = i;switch (_p25) {case 1: return Triangle;case 2: return Circle;case 3: return Square;default: return Square;}};
   var nextShape = function (m) {
      var gen = A2($Random.$int,1,3);
      var _p26 = A2($Random.generate,gen,m.seed);
      var i = _p26._0;
      var seed$ = _p26._1;
      var newShape = toCard(i);
      return _U.update(m,{seed: seed$,prevShape: $Maybe.Just(m.shape),shape: newShape,nShape: m.nShape + 1});
   };
   var restartGame = function (model) {
      var startModel = $Basics.fst(init);
      return function (model) {
         return _U.update(startModel,
         {stage: Playing,seed: model.seed,personalBest: model.personalBest,prevShape: $Maybe.Nothing,shape: model.shape,timeLeft: totalTime});
      }(nextShape(model));
   };
   var update = F2(function (input,model) {
      var newModel = function () {
         var _p27 = input;
         switch (_p27.ctor)
         {case "CurrentTime": var _p28 = _p27._0;
              if (_p28.ctor === "Just") {
                    return function (n) {
                       return _U.update(model,{seed: $Random.initialSeed(n)});
                    }($Basics.floor(A2(F2(function (x,y) {    return x * y;}),1000000,_p28._0)));
                 } else {
                    return model;
                 }
            case "Load": if (_p27._0.ctor === "Ok" && _p27._0._0.ctor === "Just") {
                    var _p29 = $String.toInt(_p27._0._0._0);
                    if (_p29.ctor === "Err") {
                          return model;
                       } else {
                          return _U.update(model,{personalBest: $Maybe.Just(_p29._0)});
                       }
                 } else {
                    return model;
                 }
            case "Action": return _p27._0(model);
            default: var _p30 = model.stage;
              switch (_p30.ctor)
              {case "Welcome": var _p31 = input;
                   if (_p31.ctor === "KeyPress") {
                         return restartGame(model);
                      } else {
                         return model;
                      }
                 case "GameOver": var _p32 = input;
                   if (_p32.ctor === "KeyPress") {
                         return _U.update(model,{stage: GameOverGetReady});
                      } else {
                         return model;
                      }
                 case "GameOverGetReady": var _p33 = input;
                   if (_p33.ctor === "KeyPress") {
                         return restartGame(model);
                      } else {
                         return model;
                      }
                 default: var _p34 = input;
                   switch (_p34.ctor)
                   {case "TimeDelta": var timeLeft$ = model.timeLeft - _p34._0;
                        return _U.cmp(timeLeft$,0) > 0 ? _U.update(model,{timeLeft: timeLeft$}) : _U.update(model,{stage: GameOver});
                      case "KeyPress": var _p36 = _p34._0;
                        var _p35 = _p36;
                        if (_p35.ctor === "Up") {
                              return restartGame(model);
                           } else {
                              return nextShape(A2(score,_p36,model));
                           }
                      default: return model;}}}
      }();
      var ret = function () {
         var noNewScore = {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         var _p37 = model.stage;
         if (_p37.ctor === "GameOver") {
               var saveEff = A2($Effects.map,$Basics.always(SaveScore),$Effects.task(setPersonalBest(model.pointsOverall)));
               var withNewScore = {ctor: "_Tuple2",_0: _U.update(newModel,{personalBest: $Maybe.Just(model.pointsOverall)}),_1: saveEff};
               var _p38 = model.personalBest;
               if (_p38.ctor === "Just") {
                     return _U.cmp(model.pointsOverall,_p38._0) > 0 ? withNewScore : noNewScore;
                  } else {
                     return withNewScore;
                  }
            } else {
   ...
   return _elm.SpeedMatch.values = {_op: _op
                                   ,isInitAction: isInitAction
                                   ,view: view
                                   ,init: init
                                   ,update: update
                                   ,input: input
                                   ,renderPersonalBest: renderPersonalBest
                                   ,Model: Model};
};
Elm.MemoryMatrix = Elm.MemoryMatrix || {};
Elm.MemoryMatrix.make = function (_elm) {
   "use strict";
   _elm.MemoryMatrix = _elm.MemoryMatrix || {};
   if (_elm.MemoryMatrix.values) return _elm.MemoryMatrix.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var loadCss = "\n    var head   = document.getElementsByTagName(\'head\')[0];\n    var link   = document.createElement(\'link\');\n    link.rel   = \'stylesheet\';\n    link.type  = \'text/css\';\n    link.href  = \'http://localhost:8000/style.css\';\n    link.media = \'all\';\n    head.appendChild(link);";
   var embedSvg = F3(function (mclass,model,rects) {
      var $float = function (a) {    return _U.list([{ctor: "_Tuple2",_0: "float",_1: a}]);};
      var pb = function () {    var _p0 = model.personalBest;if (_p0.ctor === "Just") {    return _p0._0;} else {    return 0;}}();
      var personalBest = A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style($float("left"))]),
              _U.list([$Html.text(A2($Basics._op["++"],"tiles: ",$Basics.toString(model.ntiles)))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.style($float("right"))]),
              _U.list([$Html.text(A2($Basics._op["++"],"to beat: ",$Basics.toString(pb)))]))]));
      var loadCssNode = A3($Html.node,"script",_U.list([]),_U.list([$Html.text(loadCss)]));
      var classname = function () {    var _p1 = mclass;if (_p1.ctor === "Just") {    return _p1._0;} else {    return "";}}();
      var h = "400";
      var w = "400";
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($String.join," ",_U.list([classname,"sub-container"])))]),
      A2($List._op["::"],loadCssNode,A2($List._op["::"],personalBest,rects)))]));
   });
   var colorRect = function (r) {    return r.clicked ? r.target ? "#80D945" : "#FF653A" : "white";};
   var renderGridUsing = F2(function (renderFn,grid) {
      var renderGrid$ = F2(function (g,l) {
         var tableCell = function (el) {    return A2($Html.div,_U.list([$Html$Attributes.$class("cell")]),_U.list([el]));};
         var tableRow = $Html.div(_U.list([$Html$Attributes.$class("row")]));
         var table = $Html.div(_U.list([$Html$Attributes.$class("table")]));
         return table(A3($Array.foldl,
         F2(function (row,l) {
            return A2(F2(function (x,y) {    return A2($List._op["::"],x,y);}),
            tableRow(A3($Array.foldl,F2(function (r,l) {    return A2($List._op["::"],tableCell(renderFn(r)),l);}),_U.list([]),row)),
            l);
         }),
         l,
         grid));
      });
      return _U.list([A2(renderGrid$,grid,_U.list([]))]);
   });
   var updateGridUsing = F3(function (_p2,fn,grid) {
      var _p3 = _p2;
      var _p8 = _p3._1;
      var _p7 = _p3._0;
      var mcol = A2($Array.get,_p7,grid);
      var _p4 = mcol;
      if (_p4.ctor === "Nothing") {
            return grid;
         } else {
            var _p6 = _p4._0;
            var existRect = A2($Array.get,_p8,_p6);
            var _p5 = fn(existRect);
            if (_p5.ctor === "Nothing") {
                  return grid;
               } else {
                  var newcol = A3($Array.set,_p8,_p5._0,_p6);
                  return A3($Array.set,_p7,newcol,grid);
               }
         }
   });
   var updateGrid = F3(function (pos,rect,grid) {    return A3(updateGridUsing,pos,$Basics.always($Maybe.Just(rect)),grid);});
   var foldGrid = F3(function (fn,init,grid) {    return A3($Array.foldl,F2(function (col,acc) {    return A3($Array.foldl,fn,acc,col);}),init,grid);});
   var gridGet = F2(function (_p9,grid) {
      var _p10 = _p9;
      var mcol = A2($Array.get,_p10._0,grid);
      var _p11 = mcol;
      if (_p11.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            return A2($Array.get,_p10._1,_p11._0);
         }
   });
   var clickRect = F2(function (r,a) {    return A3(updateGrid,r.position,_U.update(r,{clicked: true}),a);});
   var computeGridDims = function (model) {
      var ncells = $Basics.toFloat(model.ntiles) / model.targetRatio;
      var side = $Basics.ceiling($Basics.sqrt(ncells));
      return {ctor: "_Tuple2",_0: side,_1: side};
   };
   var advanceGame = function (model) {    return _U.update(model,{ntiles: model.ntiles + 1});};
   var needsTime = function (model) {
      var _p12 = model.stage;
      if (_p12.ctor === "Remember" && _p12._0.ctor === "Timelapse") {
            return true;
         } else {
            return false;
         }
   };
   var makeRect = F3(function (pos,clicked,target) {    return {position: pos,clicked: clicked,target: target};});
   var emptyRect = function (pos) {    return A3(makeRect,pos,false,false);};
   var targetRect = function (pos) {    return A3(makeRect,pos,false,true);};
   var pointsToGrid = F3(function (nrows,ncols,targets) {
      var grid = A2($Array.initialize,
      nrows,
      function (x) {
         return A2($Array.initialize,ncols,function (y) {    return emptyRect({ctor: "_Tuple2",_0: x,_1: y});});
      });
      return A3($List.foldl,F2(function (r,g) {    return A3(updateGrid,r,targetRect(r),g);}),grid,targets);
   });
   var Finished = {ctor: "Finished"};
   var Timelapse = function (a) {    return {ctor: "Timelapse",_0: a};};
   var countdown = F2(function (t,counter) {
      var _p13 = counter;
      if (_p13.ctor === "Timelapse") {
            var _p14 = _p13._0;
            return _U.cmp(_p14,0) > 0 ? Timelapse(_p14 - t) : Finished;
         } else {
            return counter;
         }
   });
   var handleTime = F5(function (delta,count,stageCtor,onFinish,model) {
      var newCount = A2(countdown,delta,count);
      return _U.eq(newCount,Finished) ? onFinish(model) : _U.update(model,{stage: stageCtor(newCount)});
   });
   var PersonalBestSaved = {ctor: "PersonalBestSaved"};
   var setPersonalBest = function (pb) {
      return A2($Task.map,$Basics.always(PersonalBestSaved),$Task.toResult(A2($Helpers.set,"MemoryMatrixPersonalBest",$Basics.toString(pb))));
   };
   var PersonalBestLoaded = function (a) {    return {ctor: "PersonalBestLoaded",_0: a};};
   var getPersonalBest = A2($Task.map,PersonalBestLoaded,$Task.toResult($Helpers.get("MemoryMatrixPersonalBest")));
   var CurrentTime = function (a) {    return {ctor: "CurrentTime",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var TimeDelta = function (a) {    return {ctor: "TimeDelta",_0: a};};
   var input = A2($Signal.map,TimeDelta,$Time.fps(3));
   var RectClick = function (a) {    return {ctor: "RectClick",_0: a};};
   var renderRect = F3(function (address,mcolor,r) {
      var clicked = r.clicked ? "clicked" : "";
      var position = {ctor: "_Tuple2",_0: "position",_1: "static"};
      var border = 1;
      var h = 50;
      var hs = {ctor: "_Tuple2",_0: "height",_1: A2($Basics._op["++"],$Basics.toString(h),"px")};
      var w = 50;
      var ws = {ctor: "_Tuple2",_0: "width",_1: A2($Basics._op["++"],$Basics.toString(w),"px")};
      var _p15 = r.position;
      var xc = _p15._0;
      var yc = _p15._1;
      var left = {ctor: "_Tuple2",_0: "left",_1: A2($Basics._op["++"],$Basics.toString(xc * (w + border)),"px")};
      var top = {ctor: "_Tuple2",_0: "top",_1: A2($Basics._op["++"],$Basics.toString(yc * (h + border)),"px")};
      var color = function () {    var _p16 = mcolor;if (_p16.ctor === "Nothing") {    return colorRect(r);} else {    return _p16._0;}}();
      var bgcolor = {ctor: "_Tuple2",_0: "background-color",_1: color};
      var style = _U.list([position,ws,hs,top,left,bgcolor]);
      return A2($Html.div,
      _U.list([$Svg$Attributes.$class(A2($Basics._op["++"],"square ",clicked))
              ,$Svg$Events.onClick(A2($Signal.message,address,RectClick(r)))
              ,$Html$Attributes.style(style)]),
      _U.list([]));
   });
   var renderGrid = function (address) {    return renderGridUsing(A2(renderRect,address,$Maybe.Nothing));};
   var renderExposed = function (address) {
      return renderGridUsing(function (r) {    return A3(renderRect,address,$Maybe.Nothing,r.target ? _U.update(r,{clicked: true}) : r);});
   };
   var renderGridReset = function (address) {    return renderGridUsing(A2(renderRect,address,$Maybe.Just("#DADADA")));};
   var StartGame = {ctor: "StartGame"};
   var renderWelcome = function (address) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Html.text("welcome")
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,StartGame)]),_U.list([$Html.text("Start game")]))]))]));
   };
   var view = F2(function (address,model) {
      var _p17 = model.stage;
      switch (_p17.ctor)
      {case "Welcome": return renderWelcome(address);
         case "ResetGrid": return A3(embedSvg,$Maybe.Just("reset"),model,A2(renderGridReset,address,model.rects));
         case "Remember": return A3(embedSvg,$Maybe.Nothing,model,A2(renderExposed,address,model.rects));
         case "Playing": return A3(embedSvg,$Maybe.Nothing,model,A2(renderGrid,address,model.rects));
         case "Mistake": return A3(embedSvg,$Maybe.Nothing,model,A2(renderExposed,address,model.rects));
         case "Success": return A3(embedSvg,$Maybe.Nothing,model,A2(renderExposed,address,model.rects));
         default: return A2($Html.div,_U.list([]),_U.list([$Html.text("exit")]));}
   });
   var isInitAction = function (action) {
      var _p18 = action;
      switch (_p18.ctor)
      {case "PersonalBestLoaded": return true;
         case "CurrentTime": return true;
         default: return false;}
   };
   var Exit = {ctor: "Exit"};
   var Success = function (a) {    return {ctor: "Success",_0: a};};
   var gridSolved = function (model) {
      var solved = A3(foldGrid,F2(function (r,result) {    return r.target ? r.clicked && result : result;}),true,model.rects);
      return solved ? _U.update(model,{stage: Success(Timelapse(500))}) : model;
   };
   var Mistake = F2(function (a,b) {    return {ctor: "Mistake",_0: a,_1: b};});
   var revealRect = F2(function (rect,model) {
      var clckdRect = _U.update(rect,{clicked: true});
      var grid = A2(clickRect,rect,model.rects);
      var model$ = _U.update(model,{rects: grid});
      return $Basics.not(rect.target) ? _U.update(model$,{stage: A2(Mistake,clckdRect,Timelapse(1000))}) : gridSolved(model$);
   });
   var Playing = {ctor: "Playing"};
   var Remember = function (a) {    return {ctor: "Remember",_0: a};};
   var ResetGrid = function (a) {    return {ctor: "ResetGrid",_0: a};};
   var resetGrid = function (model) {    return _U.update(model,{stage: ResetGrid(Timelapse(500))});};
   var Welcome = {ctor: "Welcome"};
   var Rect = F3(function (a,b,c) {    return {position: a,clicked: b,target: c};});
   var Model = F8(function (a,b,c,d,e,f,g,h) {    return {seed: a,nrows: b,ncols: c,targetRatio: d,rects: e,stage: f,ntiles: g,personalBest: h};});
   var split = F2(function (n,l) {
      var split$ = F3(function (n,l,r) {
         split$: while (true) if (_U.cmp(n,0) > 0) {
               var _p19 = l;
               if (_p19.ctor === "::") {
                     var _v13 = n - 1,_v14 = _p19._1,_v15 = A2($List._op["::"],_p19._0,r);
                     n = _v13;
                     l = _v14;
                     r = _v15;
                     continue split$;
                  } else {
                     return {ctor: "_Tuple2",_0: r,_1: l};
                  }
            } else return {ctor: "_Tuple2",_0: r,_1: l};
      });
      return A3(split$,n,l,_U.list([]));
   });
   var shuffle = F2(function (l,seed) {
      var n = $List.length(l);
      var listGen = A2($Random.list,n,A2($Random.$int,0,n));
      var _p20 = A2($Random.generate,listGen,seed);
      var l$ = _p20._0;
      var seed$ = _p20._1;
      var zipped = A3($List.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),l,l$);
      return function (_p21) {
         return A3($Basics.flip,
         F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
         seed$,
         A2($List.map,$Basics.fst,A2($List.sortBy,$Basics.snd,_p21)));
      }(zipped);
   });
   var generatePoints = F2(function (_p22,seed) {
      var _p23 = _p22;
      var _p24 = _p23._1;
      var ay = _p24 - 1;
      var ys = _U.range(0,ay);
      var ax = _p23._0 - 1;
      var xs = _U.range(0,ax);
      var xsRepeated = A2($List.map,$List.repeat(_p24),xs);
      var all = A2($List.concatMap,A2($List.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),ys),xsRepeated);
      return A2(shuffle,all,seed);
   });
   var randomGrid = function (model) {
      var dims = computeGridDims(model);
      var _p25 = dims;
      var nrows = _p25._0;
      var ncols = _p25._1;
      var _p26 = A2(generatePoints,dims,model.seed);
      var l = _p26._0;
      var seed$ = _p26._1;
      var _p27 = A2(split,model.ntiles,l);
      var h = _p27._0;
      var t = _p27._1;
      var rs = A3(pointsToGrid,nrows,ncols,h);
      return _U.update(model,{rects: rs,seed: seed$,stage: ResetGrid(Timelapse(500))});
   };
   var init = {ctor: "_Tuple2"
              ,_0: randomGrid({seed: $Random.initialSeed(20)
                              ,nrows: 5
                              ,ncols: 5
                              ,targetRatio: 0.7
                              ,rects: $Array.empty
                              ...
                              ,ntiles: 3
                              ,personalBest: $Maybe.Nothing})
              ,_1: $Effects.batch(_U.list([$Effects.task(A2($Task.map,CurrentTime,$TaskTutorial.getCurrentTime)),$Effects.task(getPersonalBest)]))};
   var update = F2(function (input,model) {
      var model2 = function () {
         var _p28 = input;
         switch (_p28.ctor)
         {case "PersonalBestLoaded": var _p29 = _p28._0;
              if (_p29.ctor === "Ok" && _p29._0.ctor === "Just") {
                    var _p30 = $String.toInt(_p29._0._0);
                    if (_p30.ctor === "Err") {
                          return model;
                       } else {
                          return _U.update(model,{personalBest: $Maybe.Just(_p30._0)});
                       }
                 } else {
                    return model;
                 }
            case "CurrentTime": return _U.update(model,{seed: $Random.initialSeed($Basics.floor(_p28._0))});
            case "NoOp": return model;
            case "TimeDelta": var _p33 = _p28._0;
              var _p31 = model.stage;
              switch (_p31.ctor)
              {case "Remember": return A5(handleTime,_p33,_p31._0,Remember,function (m) {    return _U.update(m,{stage: Playing});},model);
                 case "Success": return A5(handleTime,_p33,_p31._0,Success,function (_p32) {    return randomGrid(advanceGame(_p32));},model);
                 case "Mistake": return A5(handleTime,_p33,_p31._1,Mistake(_p31._0),randomGrid,model);
                 case "ResetGrid": return A5(handleTime,
                   _p33,
                   _p31._0,
                   ResetGrid,
                   function (m) {
                      return _U.update(m,{stage: Remember(Timelapse(1500))});
                   },
                   model);
                 default: return model;}
            case "StartGame": return function (_p34) {
                 return randomGrid(advanceGame(_p34));
              }(model);
            case "RectClick": var _p35 = model.stage;
              if (_p35.ctor === "Playing") {
                    return A2(revealRect,_p28._0,model);
                 } else {
                    return model;
                 }
            default: return model;}
      }();
      var updt = function (pb) {    return {ctor: "_Tuple2",_0: _U.update(model2,{personalBest: $Maybe.Just(pb)}),_1: $Effects.task(setPersonalBest(pb))};};
      var _p36 = function () {
         var _p37 = model.stage;
         if (_p37.ctor === "Success") {
               var _p38 = model.personalBest;
               if (_p38.ctor === "Just") {
                     return _U.cmp(_p38._0,model.ntiles) < 0 ? updt(model.ntiles) : {ctor: "_Tuple2",_0: model2,_1: $Effects.none};
                  } else {
                     return updt(model.ntiles);
                  }
            } else {
               return {ctor: "_Tuple2",_0: model2,_1: $Effects.none};
            }
      }();
      var m = _p36._0;
      var eff = _p36._1;
      return {ctor: "_Tuple2",_0: m,_1: eff};
   });
   ...
   return _elm.MemoryMatrix.values = {_op: _op,update: update,init: init,isInitAction: isInitAction,view: view,input: input,Model: Model};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $MemoryMatrix = Elm.MemoryMatrix.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SpeedMatch = Elm.SpeedMatch.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var hash = Elm.Native.Port.make(_elm).inboundSignal("hash",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var gameHash = function (game) {    return A2($Basics._op["++"],"#",$Basics.toString(game));};
   var gameDesc = F2(function (game,model) {
      var _p0 = game;
      if (_p0.ctor === "SpeedMatchGame") {
            return A2($Html.div,
            _U.list([]),
            _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text("Speed Match")])),$SpeedMatch.renderPersonalBest(model.speedMatchModel)]));
         } else {
            return A2($Html.div,
            _U.list([]),
            _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text("Memory Matrix")]))
                    ,$Html.text(A2($Basics._op["++"],"Personal best: ",$Basics.toString(A2($Maybe.withDefault,0,model.memoryMatrixModel.personalBest))))]));
         }
   });
   var handleUpdate = F6(function (action,model,update,setter,getter,mapper) {
      var _p1 = A2(update,action,getter(model));
      var m = _p1._0;
      var fx = _p1._1;
      return {ctor: "_Tuple2",_0: A2(setter,model,m),_1: A2($Effects.map,mapper,fx)};
   });
   var MemoryMatrix = function (a) {    return {ctor: "MemoryMatrix",_0: a};};
   var SpeedMatch = function (a) {    return {ctor: "SpeedMatch",_0: a};};
   var LocationHashChange = function (a) {    return {ctor: "LocationHashChange",_0: a};};
   var Select = function (a) {    return {ctor: "Select",_0: a};};
   var renderChooseGame = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("home-screen")]),
      A3($Basics.flip,
      F2(function (x,y) {    return A2($List._op["::"],x,y);}),
      _U.list([]),
      A2($Html.div,
      _U.list([$Html$Attributes.$class("tiles-container")]),
      A2($List.map,
      function (g) {
         return A2($Html.a,
         _U.list([A2($Html$Events.onClick,address,Select(g)),$Html$Attributes.$class("tile"),$Html$Attributes.href(gameHash(g))]),
         _U.list([A2(gameDesc,g,model)]));
      },
      model.games))));
   });
   var view = F2(function (address,model) {
      var _p2 = model.currentGame;
      if (_p2.ctor === "Just") {
            var _p3 = _p2._0;
            if (_p3.ctor === "SpeedMatchGame") {
                  return A2($Html.div,_U.list([]),_U.list([A2($SpeedMatch.view,A2($Signal.forwardTo,address,SpeedMatch),model.speedMatchModel)]));
               } else {
                  return A2($Html.div,_U.list([]),_U.list([A2($MemoryMatrix.view,A2($Signal.forwardTo,address,MemoryMatrix),model.memoryMatrixModel)]));
               }
         } else {
            return A2(renderChooseGame,address,model);
         }
   });
   var MemoryMatrixGame = {ctor: "MemoryMatrixGame"};
   var SpeedMatchGame = {ctor: "SpeedMatchGame"};
   var hashToGame = function (hash) {
      var _p4 = hash;
      switch (_p4)
      {case "#MemoryMatrixGame": return $Maybe.Just(MemoryMatrixGame);
         case "#SpeedMatchGame": return $Maybe.Just(SpeedMatchGame);
         default: return $Maybe.Nothing;}
   };
   var update = F2(function (action,model) {
      var modelAct = function () {
         var _p5 = action;
         switch (_p5.ctor)
         {case "LocationHashChange": return {ctor: "_Tuple2",_0: _U.update(model,{currentGame: hashToGame(_p5._0)}),_1: $Effects.none};
            case "Select": return {ctor: "_Tuple2",_0: _U.update(model,{currentGame: $Maybe.Just(_p5._0)}),_1: $Effects.none};
            case "SpeedMatch": var _p8 = _p5._0;
              var _p6 = $SpeedMatch.isInitAction(_p8);
              if (_p6 === true) {
                    return A6(handleUpdate,
                    _p8,
                    model,
                    $SpeedMatch.update,
                    F2(function (pm,m) {    return _U.update(pm,{speedMatchModel: m});}),
                    function (pm) {
                       return pm.speedMatchModel;
                    },
                    SpeedMatch);
                 } else {
                    var _p7 = model.currentGame;
                    if (_p7.ctor === "Nothing") {
            ...
            default: var _p11 = _p5._0;
              var _p9 = $MemoryMatrix.isInitAction(_p11);
              if (_p9 === true) {
                    return A6(handleUpdate,
                    _p11,
                    model,
                    $MemoryMatrix.update,
                    F2(function (pm,m) {    return _U.update(pm,{memoryMatrixModel: m});}),
                    function (pm) {
                       return pm.memoryMatrixModel;
                    },
                    MemoryMatrix);
                 } else {
                    var _p10 = model.currentGame;
   ...
   var init = function () {
      var _p12 = $MemoryMatrix.init;
      var mmModel = _p12._0;
      var mmFx = _p12._1;
      var _p13 = $SpeedMatch.init;
      var smModel = _p13._0;
      var smFx = _p13._1;
      return {ctor: "_Tuple2"
             ,_0: {speedMatchModel: smModel,memoryMatrixModel: mmModel,games: _U.list([SpeedMatchGame,MemoryMatrixGame]),currentGame: $Maybe.Nothing}
             ,_1: $Effects.batch(_U.list([A2($Effects.map,SpeedMatch,smFx),A2($Effects.map,MemoryMatrix,mmFx)]))};
   }();
   var app = $StartApp.start({init: init
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([A2($Signal.map,SpeedMatch,$SpeedMatch.input)
                                              ,A2($Signal.map,MemoryMatrix,$MemoryMatrix.input)
                                              ,A2($Signal.map,LocationHashChange,hash)])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   var Model = F4(function (a,b,c,d) {    return {speedMatchModel: a,memoryMatrixModel: b,currentGame: c,games: d};});
   return _elm.Main.values = {_op: _op
                             ,Model: Model
                             ,SpeedMatchGame: SpeedMatchGame
                             ,MemoryMatrixGame: MemoryMatrixGame
                             ,Select: Select
                             ,LocationHashChange: LocationHashChange
                             ,SpeedMatch: SpeedMatch
                             ,MemoryMatrix: MemoryMatrix
                             ,handleUpdate: handleUpdate
                             ,update: update
                             ,gameDesc: gameDesc
                             ,hashToGame: hashToGame
                             ,gameHash: gameHash
                             ,init: init
                             ,view: view
                             ,renderChooseGame: renderChooseGame
                             ,app: app
                             ,main: main};
};
